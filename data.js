...
var writeHistory = (rtn) => {
    _new.write(`${payload.batch}.history`)
        ...
        .field({
            ...
            dozer_position: stats.stats.awc.actual_RHS,
            ...
            rjn_high: processed.limit[3],
            rjn_low: processed.limit[2],
            force_line: processed.limit[16],
...
var writeAverage = (rtn) => {
    _new.write(`${payload.batch}.average`)
        ...
        .field({
            ...
            preavg: payload.precompressionLHS_avg,
            mainavg: payload.maincompressionLHS_avg,
            ejnavg: payload.ejectionLHS_avg,
